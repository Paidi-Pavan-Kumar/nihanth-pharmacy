            ...
            <div className="flex justify-end mt-6 gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  window.open(`mailto:${selectedContact.email}?subject=Re: Your message to Nihanth Pharmacy&body=Dear ${selectedContact.name},%0D%0A%0D%0AThank you for contacting us.%0D%0A%0D%0A`);
                }}
